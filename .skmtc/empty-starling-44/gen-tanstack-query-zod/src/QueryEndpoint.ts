import type { Stringable, OperationInsertableArgs, ListArray } from 'jsr:@skmtc/core@^0.0.731'
import { List, capitalize, FunctionParameter } from 'jsr:@skmtc/core@^0.0.731'
